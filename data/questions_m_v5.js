/**
 * /data/questions_m_v5.js
 * Version: v5.0.0 (WIP)
 * 说明：MY GIFT 动机问卷 v5 版题库占位文件。
 * 当前阶段先完全复制 v4.1 题目，后续在这个文件里做：
 * - 题目微调 / 增减
 * - A/R/C 维度标签校准
 * - 题目权重与 reverse 规则调整
 *
 * ⚠️ 注意：目前主计算仍然使用 questions_m.js，
 * 只有等我们显式切换后，v5 题库才会进入正式计算。
 */
...
const M_QUESTIONS = [
  // Autonomy 自主性（A）
  {
    id: 1,
    code: "M_A_1",
    dimension: "M_A",   // v5: Autonomy（自主性）——已确认
    reverse: false,     // v5: 正向题（分数越高，自主驱动力越高）
  ...
  },
  {
    ...
    code: "M_A_3",
    dimension: "M_A",   // v5: Autonomy（自主性）——已确认
    reverse: true,      // v5: 反向题（分数越高，自主驱动力越低）
  ...
  // Relatedness 关系性（R）
  {
    id: 7,
    code: "M_R_1",
    dimension: "M_R",   // v5: Relatedness（关系/连结）——已确认
    reverse: false,     // v5: 正向题（分数越高，关系驱动力越高）
  ...
  },
  {
    ...
    code: "M_R_3",
    dimension: "M_R",   // v5: Relatedness（关系/连结）——已确认
    reverse: true,      // v5: 反向题（分数越高，关系驱动力越低）
  ...
  // Competence 能力感（C）
  {
    id: 13,
    code: "M_C_1",
    dimension: "M_C",   // v5: Competence（能力/成就）——已确认
    reverse: false,     // v5: 正向题（分数越高，成就驱动力越高）
  ...
  },
  {
    ...
    code: "M_C_3",
    dimension: "M_C",   // v5: Competence（能力/成就）——已确认
    reverse: true,      // v5: 反向题（分数越高，成就驱动力越低）
